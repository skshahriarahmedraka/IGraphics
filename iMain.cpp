...
void iDraw()
{
	...
	if (screen == 0){
		...
		iShowBMP(0, 0, "music\\pic4.bmp");
		iShowBMP2(0, 0, "music\\extra1.bmp",255);
		iShowBMP2(600, 460, "music\\121.bmp",0 );
		iShowBMP2(650, 340, "music\\124.bmp", 0);
		iShowBMP2(650, 220, "music\\122.bmp", 0);
		iShowBMP2(650, 100, "music\\125.bmp", 0);

		iShowBMP2(50, 500, "music\\extra15.bmp", 0);
		iShowBMP2(100, 300, "music\\extra13.bmp", 0);
		 music = true;
		 m2 = 0;
		 live = 5;
		 k = 1, k2 = 1, b = 0;
	 ...
	 y2_[0] =  350; y2_[1] = 350; y2_[2] = 170; y2_[3] = 170;
		...
		iShowBMP(0, 0, "music\\pic3.bmp");
		iShowBMP2(0, 0, "music\\extra2.bmp", 255);
		iShowBMP2(300, 200, "music\\comm3.bmp", 255);
	}
			...
			iShowBMP2(480, 400, "music\\l1.bmp", 255);
			iShowBMP2(480, 200, "music\\vl1.bmp", 255);
			/////
			if (k == 1){
			...
			if (hunterlife==0){
				iShowBMP2(400, 400, "music\\gameover.bmp", 255);
				iShowBMP2(450, 300, "music\\gameover2.bmp", 255);
				iShowBMP2(410, 610, scorecard[sco / 100], 255);
				iShowBMP2(450, 200, scorecard[sco/10], 255);
				iShowBMP2(490, 200, scorecard[sco % 10], 255);
				iShowBMP2(0, 0, "music\\gameover3.bmp", 255);
		...
		iShowBMP(0, 0, "music\\6_1.bmp");
		iShowBMP(50, 300, "music\\131.bmp");
		iShowBMP(360, 300, "music\\132.bmp");
		iShowBMP(670, 300, "music\\133.bmp");
		iShowBMP2(200, 600, "music\\team.bmp", 255);
		iSetColor(255, 255, 255);
		iText(50, 260, "Md. Lokman Hossen", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(50, 230, "Roll: 180105", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(50, 200, "email: ", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(50, 170, "lokmanhossen230", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(50, 140, "@gmail.com", GLUT_BITMAP_TIMES_ROMAN_24);

		iText(360, 260, "Sk Shahriar Ahmed Raka", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(360, 230, "Roll: 180107", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(360, 200, "email:", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(360, 170, "skshahriarahmedraka", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(360, 140, "@gmail.com", GLUT_BITMAP_TIMES_ROMAN_24);


		iText(670, 260, "Jagannath Chandra Das", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(670, 230, "Roll: 180108", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(670, 200, "email:", GLUT_BITMAP_TIMES_ROMAN_24);
		iText(670, 170, "jagannath.cse.pust10@gmail.com", GLUT_BITMAP_TIMES_ROMAN_24);
...
int main()
{
		...
		iSetTimer(20, change);
		iSetTimer(5000, change2);
		iSetTimer(15000, change1);
	iInitialize(1050, 700, "Hunter Heart");
	if (music)
		PlaySound("music\\kung.wav", NULL, SND_LOOP | SND_ASYNC);
